...
##                        Measurement Error                         ##
##                                                                  ## 
##      CODE AUTHORS:     THOMAS S. ROBINSON (APRIL 2019)           ##
...
# Add brackets around rounded values, for table production
...
# ggsave(figure, filename = "BART_ability_rank.png", device = "png", height = 8, width = 6)
...
## Figure 4 - banded bootstrap test for age covariate
...
# Not run:
ggsave(figure, filename = "banded_test_all_vs_mturk-NEW.png", device = "png", height = 5, width = 9)
...
xt<-xtable(sum.table)
print(xt, type="latex", file=("summary_table.tex"), floating=FALSE, include.rownames=FALSE)
